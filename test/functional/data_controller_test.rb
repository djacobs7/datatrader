...
class DataControllerTest < ActionController::TestCase
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post :create, datum: { data: @datum.data, description: @datum.description, name: @datum.name, schema: @datum.schema }
    end
  ...
  test "should update datum" do
    put :update, id: @datum, datum: { data: @datum.data, description: @datum.description, name: @datum.name, schema: @datum.schema }
    assert_redirected_to datum_path(assigns(:datum))
  end
